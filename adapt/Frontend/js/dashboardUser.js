...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const res = await fetch("https://adaptlearn-backend-wgnd.onrender.com/api/progress/summary", {
...
async function loadUserProgress() {
  ...
  try {
    const res = await fetch("https://adaptlearn-backend-wgnd.onrender.com/api/progress/user", {
      headers: { Authorization: `Bearer ${token}` },
    });
